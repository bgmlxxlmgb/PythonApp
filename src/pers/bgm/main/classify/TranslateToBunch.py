...
if __name__ == "__main__":  # 这个语句前面的代码已经介绍过，今后不再注释
    # 对训练集进行Bunch化操作：
    wordbag_path = "F:\\Development\\Code\\classify\\train_set.dat"  # Bunch存储路径
    seg_path = "F:\\Development\\Code\\classify\\train_seg\\"  # 分词后分类语料库路径
    corpus2Bunch(wordbag_path, seg_path)

    # 对测试集进行Bunch化操作：
    wordbag_path = "F:\\Development\\Code\\classify\\test_set.dat"  # Bunch存储路径
    seg_path = "F:\\Development\\Code\\classify\\answer_seg\\"  # 分词后分类语料库路径
    corpus2Bunch(wordbag_path, seg_path)